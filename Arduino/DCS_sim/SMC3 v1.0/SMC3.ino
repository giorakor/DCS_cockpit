    ...
    case 'r':
        if (RxBuffer[1][ComPort] == 'd') // rd - Read a value from the ArduinoPID - next byte identifies value to read
        {
            ...
            case 'B':
                ...
                break;
            case 'a':
                SendTwoValues('a', PIDProcessDivider * 16 + Disable1 + (Disable2 * 2), constrain(PWMout1, 0, 255), ComPort);
                break;
            case 'b':
                SendTwoValues('b', PIDProcessDivider * 16 + Disable1 + (Disable2 * 2), constrain(PWMout2, 0, 255), ComPort);
                break;
            case 'c':
                SendTwoValues('c', PIDProcessDivider * 16 + Disable1 + (Disable2 * 2), constrain(PWMout3, 0, 255), ComPort);
                break;
            case 'D':
            ...
            case 'W':
                ...
                break;
            case 'Y':
                SendTwoValues('Y', PIDProcessDivider * 16 + Disable1 + (Disable2 * 2), 0, ComPort); // Second byte not yet used
                break;
            case 'Z':
